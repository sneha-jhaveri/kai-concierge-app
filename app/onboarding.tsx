        ...
        <View style={styles.analysisContainer}>
          <View style={styles.analysisContent}>
            ...
            <Text style={styles.analysisSubtitle}>
              Kai is analyzing your {selectedPlatform} profile to create your personalized experience
            </Text>
            ...
            <Text style={styles.currentStep}>{analysisSteps[analysisStep]}</Text>

            <View style={styles.analysisFeatures}>
              <View style={styles.featureItem}>
                <Sparkles size={16} color="#FFD700" />
                <Text style={styles.featureText}>Learning your preferences</Text>
              </View>
              <View style={styles.featureItem}>
                <Crown size={16} color="#FFD700" />
                <Text style={styles.featureText}>Personalizing luxury services</Text>
              </View>
              <View style={styles.featureItem}>
                <Star size={16} color="#FFD700" />
                <Text style={styles.featureText}>Optimizing your experience</Text>
              </View>
            </View>
          </View>
        </View>
