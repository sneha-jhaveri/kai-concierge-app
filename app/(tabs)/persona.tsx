      ...
      {summary ? (
        <>
          <Text style={styles.itemText}>
            • Age Range: {summary.estimated_age_range}
          </Text>
          <Text style={styles.itemText}>• Gender: {summary.gender}</Text>
          <Text style={styles.itemText}>• Location: {summary.location}</Text>
          <Text style={styles.itemText}>
            • Active Timezone: {summary.active_timezone}
          </Text>
          <Text style={styles.itemText}>
            • Communication Style: {summary.communication_style}
          </Text>
          <Text style={styles.itemText}>
            • Shopping Behavior: {summary.shopping_behavior}
          </Text>
        </>
      ) : (
